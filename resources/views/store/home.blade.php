                        ...
                        <div class="card-body">
                            <div class="widget-summary">
                                ...
                                <div class="widget-summary-col">
                                    <div class="summary">
                                        <h4 class="title">Open Ticket</h4>
                                        <div class="info">
                                            <strong class="amount">{{ $ticket_open }}</strong>
                                        </div>
                                    </div>
                                    <div class="summary-footer">
                                        <a href="{{ route('store.tickets') }}" class="text-muted text-uppercase">(view all)</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-summary">
                                ...
                                <div class="widget-summary-col">
                                    <div class="summary">
                                        ...
                                        <div class="info">
                                            <strong class="amount">{{ $discount }}</strong>
                                        </div>
                                    </div>
                                    <div class="summary-footer">
                                        <a class="text-muted text-uppercase" href="{{ route('store.discount') }}">(view all)</a>
                                    </div>
                                </div>
                            </div>
                        </div>
