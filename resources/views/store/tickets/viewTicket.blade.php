            ...
            <div class="container">
                <div class="row">
                            ...
                            @foreach($replies as $r)
                                ...
                                @else
                                    <div class="author-box">
                                        <div class="author-name">
                                            {{ $logged_author->name }}<span class="badge badge-white at-group" style="text-transform: uppercase">Me</span>
                    ...
                    <div class="col-md-12 mt-5">
                        <form action="{{ route('store.ticket.answer', ['tid' => $ticket->id]) }}" method="post">
                            @csrf
                            <label>Message</label>
