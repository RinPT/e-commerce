                    ...
                    <div class="header-left">
                        <nav class="main-nav">
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="{{ route('store') }}">Electronics</a>
                                    <div class="megamenu">
                                        <div class="row">
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-4">
                                                <h4 class="menu-title">Variations 1</h4>
