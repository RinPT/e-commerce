                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2-5 col-xl-1-5">
                            ...
                            <h2 class="card-big-info-title">Add New Store Discount</h2>
                            <p class="card-big-info-desc">Add here all details and necessary information.</p>
                        </div>
                        <div class="col-lg-3-5 col-xl-4-5">
                            <form class="form-horizontal form-bordered" action="{{ route('store.discount.create') }}" method="POST">
                                @csrf
                                <div class="form-group row @error('name') has-danger @enderror">
                                    <label class="col-lg-3 control-label text-lg-right pt-2" for="inputDefault">Select Store</label>
                                    <div class="col-lg-6">
                                        <select name="store_id" data-plugin-selectTwo class="form-control populate">
                                ...
                                <div class="form-group row @error('main_discount') has-danger @enderror">
                                    ...
                                    <div class="col-lg-6">
                                        <input name="main_discount" type="number" class="form-control" id="inputDefault" value="{{ old('main_discount') }}">
                                    </div>
                                </div>
