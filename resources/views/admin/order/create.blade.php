                ...
                <div class="col-lg-3-5 col-xl-4-5">
                    ...
                    <form action="{{ route('admin.order.store') }}" class="form-horizontal form-bordered mt-5" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="store_name" class="form-control" id="inputDefault" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="store_url" class="form-control" id="inputDefault" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="user_id" class="form-control" id="inputDefault" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="user_type" list="user_type" class="form-control" id="inputDefault" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="gender" list="gender" class="form-control" id="inputDefault"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="comment" class="form-control" id="inputDefault"  required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="total" class="form-control" id="inputDefault"  required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="order_status" list="order_status" class="form-control" id="inputDefault"  required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="currency_code" class="form-control" id="inputDefault"  required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="ip_address" class="form-control" id="inputDefault"  required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="user_agent" class="form-control" id="inputDefault"  required>
                            </div>
                        </div>
