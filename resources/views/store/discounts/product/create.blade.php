                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3-5 col-xl-4-5">
                            <form class="form-horizontal form-bordered" action="{{ route('store.product.discount.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group row @error('store_discount') has-danger @enderror">
                                    <label class="col-lg-3 control-label text-lg-right pt-2" for="inputDefault">Product Discount</label>
                                    <div class="col-lg-6">
