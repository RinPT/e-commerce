        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-2-5 col-xl-1-5">
                    ...
                    <h2 class="card-big-info-title">Add New Permission</h2>
                    <p class="card-big-info-desc">You can add a new permission filling below information.</p>
                </div>
                <div class="col-lg-3-5 col-xl-4-5">
                    ...
                    @endif
                    <form action="{{ route('admin.perm.create') }}" class="form-horizontal form-bordered mt-5" method="post">
                        @csrf
