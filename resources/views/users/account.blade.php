                ...
                <div class="tab-content col-lg-9 col-md-8">
                    ...
                    <div class="tab-pane" id="address">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-4">
                                <div class="card card-address">
                                    <div class="card-body">
                                        ...
                                        <h6>{{ $address->address_type }} / {{ ucfirst($address->user_type) }}</h6>
                                        <p>{{ $address->name }} {{ $address->surname }}</p>
                                        <p>{{ $address->address }} </p>
                                        <p>{{ $address->telephone }} </p>
                                        <p>{{ $address->city }},{{ $address->postcode }}</p>
                                        <a href="{{ route('address.display', [auth()->user()->username, $address->address_id]) }}" class="btn btn-link btn-secondary btn-underline">Edit <i class="far fa-edit"></i></a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                            ...
                            @else
                            <p>There are no adresses.</p>
                            @endif
                            
                        </div>
                        <a href="{{ route('address.add', auth()->user()->username) }}" class="btn btn-link btn-secondary btn-underline">Add Address <i class="fas fa-plus"></i></a>
                    </div>
